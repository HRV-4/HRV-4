...
function UserInfoIcon({ name }: { name: string }) {
  return (
      ...
      <Modal visible={isModalVisible} animationType="slide" presentationStyle="pageSheet">
        <View style={[styles.modalContainer, { backgroundColor: isDark ? '#000' : '#F2F2F7' }]}>
          ...
          <View style={[styles.modalHeader, { backgroundColor: isDark ? '#1C1C1E' : '#FFF' }]}>
            ...
            <TouchableOpacity onPress={handleSaveProfile} hitSlop={8}>
          ...
          <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
            ...
            <TextInput
              style={[styles.input, { backgroundColor: isDark ? '#1C1C1E' : '#FFF', color: isDark ? '#FFF' : '#434F4D' }]}
              value={formData.name}
            ...
            <TextInput
              style={[styles.input, styles.textArea, { backgroundColor: isDark ? '#1C1C1E' : '#FFF', color: isDark ? '#FFF' : '#434F4D' }]}
