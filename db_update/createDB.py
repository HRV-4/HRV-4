from sqlalchemy import Interval, create_engine, Column, BigInteger, Text, Double, ForeignKey, DateTime
...
class RawData(Base):
    ...
    userID = Column(Text, ForeignKey('Users.userID'))
...
class ProcessedData(Base):
    ...
    measurement_time = Column(Interval)
...
if __name__ == "__main__":
    db_name = "again"
    db = CreateDB(f"postgresql+psycopg2://postgres:postgres@localhost:5432/{db_name}")
